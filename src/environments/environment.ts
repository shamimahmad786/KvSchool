...
export const environment = {
  ...
  //Local
	...
	// BASE_URL_DATA_MASTER: 'http://10.25.26.35:8014/api/master/',
	// BASE_URL_DATA_QUESTION: 'http://10.25.26.35:8014/api/question/',
	// BASE_URL_DATA_SURVEY: 'http://10.25.26.35:8014/api/survey/',
	// BASE_URL_DATA_EXPERIENCE: 'http://10.25.26.35:8014/api/experience/',
	// BASE_URL_DATA_PROMOTION: 'http://10.25.26.35:8014/api/promotion/',
	// BASE_URL_DATA_QUALIFICATION: 'http://10.25.26.35:8014/api/qualification/',
	// BASE_URL_DATA_AWARDS: 'http://10.25.26.35:8014/api/awards/',
	// BASE_URL_DATA_TRANSFER: 'http://10.25.26.35:8014/api/transfer/',
	// BASE_URL_DATA_DASHBOARD: 'http://10.25.26.35:8014/api/dashboard/',
	// BASE_URL_DATA_USER:'http://10.25.26.35:8090/meuser/api/user/',
	// BASE_URL_DATA_SURPLUS_TRANSFER:'http://10.25.26.35:8015/api/transfer/',
	// LOGIN_URL_JWT:'http://10.25.26.35:8014/api/login/',
	// LOGOUT_URL:'http://10.25.26.35:8385/meauth/logout?returnTo=http://localhost:4200/',
	// LOGIN_URL_INDIVIDUAL:'http://10.25.26.35:8385/meauth/oauth/authorize?response_type=code&user_oauth_approval=true&client_id=teacher&redirect_uri=http://localhost:4200/teacher/profile&scopes=read',
	...
	// AUTH_GUARD_HREF1:'http://10.25.26.35:8385/meauth/logout?returnTo=http://localhost:4200/',
	// BASE_URL_MEUSER:'http://10.25.26.35:8090/meuser/api/user/',
  // BASE_URL_REPORT:'http://10.25.26.35:8087/api/kvsreport/',
	// BASE_URL_DATA_MASTER1:'http://10.25.26.35:8014/unee-api/v1/master/',
	// BASE_URL_DATA_MAPPING:'http://10.25.26.35:8014/unee-api/v1/mapping/',
