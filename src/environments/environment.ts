...
export const environment = {
  production: false,
  //Local
  BASE_URL_DATA_TEACHER: 'http://10.25.26.251:8086/MOE-RAD-TEACHER/api/teacher/',
  BASE_URL_DATA_TEACHER_TRANSFER:'http://10.25.26.251:8086/MOE-RAD-TEACHER/api/transprofile/',
  BASE_URL_DATA_MASTER: 'http://10.25.26.251:8086/MOE-RAD-TEACHER/api/master/',
  BASE_URL_DATA_QUESTION: 'http://10.25.26.251:8086/MOE-RAD-TEACHER/api/question/',
  BASE_URL_DATA_SURVEY: 'http://10.25.26.251:8086/MOE-RAD-TEACHER/api/survey/',
  BASE_URL_DATA_EXPERIENCE: 'http://10.25.26.251:8086/MOE-RAD-TEACHER/api/experience/',
  BASE_URL_DATA_PROMOTION: 'http://10.25.26.251:8086/MOE-RAD-TEACHER/api/promotion/',
  BASE_URL_DATA_QUALIFICATION: 'http://10.25.26.251:8086/MOE-RAD-TEACHER/api/qualification/',
  BASE_URL_DATA_AWARDS: 'http://10.25.26.251:8086/MOE-RAD-TEACHER/api/awards/',
  BASE_URL_DATA_TRANSFER: 'http://10.25.26.251:8086/MOE-RAD-TEACHER/api/transfer/',
  BASE_URL_DATA_DASHBOARD: 'http://10.25.26.251:8086/MOE-RAD-TEACHER/api/dashboard/',
  ...
  LOGIN_URL_JWT:'http://10.25.26.251:8086/MOE-RAD-TEACHER/api/login/',
  ...
  BASE_URL_DATA_MASTER1:'http://10.25.26.251:8086/MOE-RAD-TEACHER/unee-api/v1/master/',
  BASE_URL_DATA_MAPPING:'http://10.25.26.251:8086/MOE-RAD-TEACHER/unee-api/v1/mapping/',
